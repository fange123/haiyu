(function($) {
	$.fn.fullpage = function(options) {
				...
				if (!isMoving) { //if theres any #
					...
					if (delta < 0) {
						...
						//鏂板姞news
						 ...
						 if(this_index_id >= 2 || pageIndex > 0 ){
		...
		*/
		...
		/**
		 * Resizing of the fonts size depending on the window size as well as some of the images on the site.
		 */
		function resizeMe(displayHeight, displayWidth) {
			//Standard dimensions, for which the body fonts size is correct
			...
			if (displayHeight < preferredHeight || displayWidth < preferredWidth) {
				...
				$("body").css("fonts-size", newFontSize + '%');
			} else {
				$("body").css("fonts-size", '100%');
			}
		}
